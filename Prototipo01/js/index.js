...
function renderCharactersList(characters) {
    ...
    for (const character of characters) {
        ...
        const card = ` 
              <div class="card mb-3 card-character" onclick="viewCharacterDetail(${character.id})" style="max-width: 540px;">
                <div class="row g-0">
                    <div class="col-md-5">
                        <div class="object-fit-fill border rounded h-100">
                           <img src="${character.image}" 
                                class="w-100 h-100 rounded" alt="Foto do Personagem ${character.name}">
                        </div>
                    </div>
                    <div class="col-md-7">
                        <div class="card-body fw-bolder">
                            ...
                            <p class="card-text">
                                <small>
                                    <i id="cicle-status" class="bib bi-circle-fill text-${mapStatus(character.status).color}"></i>
